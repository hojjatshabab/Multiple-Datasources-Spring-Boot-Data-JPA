...
@EnableJpaRepositories(basePackages = "com.multipledatasourceswithspringbootdatajpa.api.repository.bank",
...
public class BankDataSourceConfiguration {
    ...
    public LocalContainerEntityManagerFactoryBean bankEntityManagerFactory(
        ...
        return builder
                ...
                .packages("com.multipledatasourceswithspringbootdatajpa.api.model.bank")
                .build();
    }
